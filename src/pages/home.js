    ...
    <div style={{backgroundColor:"#fbfae4", height:"300vh"}}>
      <Container fluid={true}>
        <Row style={{ height:"200vh", backgroundImage:`url(${topBackground})`,backgroundSize: "100% auto", backgroundRepeat: "no-repeat"}}>
          <Col sm={2}></Col>
          <Col sm={8} style={{backgroundImage:`url(${circleRim2})`, backgroundPosition: "center", backgroundSize: "cover", backgroundRepeat: "no-repeat", height:"100vh"}}>
            <Row style={{height:"20vh"}}></Row>
            <Row style={{height:"60vh"}}>
              <label style={{margin:"auto", color:"#605448", fontFamily:"DMSerif", fontWeight: "100", fontSize: "650%"}}>APRIL LI</label>
              <div style={{marginLeft:"auto", marginRight:"auto", backgroundColor:"#605448", height:"3px", width:"50%"}}/>
              <label style={{marginTop:"0px", color:"#605448", fontFamily:"DMSerif", fontWeight: "100", fontSize: "250%"}}>Welcome to my website!</label>
            </Row>
